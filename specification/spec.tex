...
\npar In this appendix, we present a potential compilation model called single pass local compilation. This is named because it carries out a single pass through the pipeline, expanding as it goes and refusing to backtrack, and because it compiles the bundles for each step independently of the rest of the pipeline or any other pipelines.
